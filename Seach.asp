...
<%
	strURL = Request.QueryString("keywords")
...
<center>
  <table width="960" border="0" cellspacing="0" cellpadding="0" class="bigtable">
    ...
    <tr>
      ...
      <td align="center"  class="MenuLang"><a href="Seach.asp?keywords=<%=strURL%>&orderby=<%=orderby%>&page=<%=pages%>&langs=ja" class="MenuLang" target="_self">&nbsp;Japanese&nbsp;</a>&nbsp;|&nbsp;<a href="Seach.asp?keywords=<%=strURL%>&orderby=<%=orderby%>&page=<%=pages%>&langs=vn" class="MenuLang" target="_self">Vietnamese</a></td>
    </tr>
    <tr>
	  ...
	  <!--Nội dung chứa ở đây-->
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="center"><!--#Include file="Template/seachs.asp"--></td>
            </tr>
          </table>
        <!--hết phần Nội dung-->
        <br><p></p>
